...
echo -e "${BLUE}==================================================${NC}"
echo -e "${BLUE}   PARANDO AMBIENTE DE DESENVOLVIMENTO LOCAL      ${NC}"
echo -e "${BLUE}==================================================${NC}"

# Verificar se o arquivo de PIDs existe
if [ -f "dev-local-pids.txt" ]; then
  # Ler PIDs do arquivo
  PIDS=$(cat dev-local-pids.txt)
...
echo -e "${BLUE}==================================================${NC}"
echo -e "${GREEN}Ambiente de desenvolvimento local parado!${NC}"
echo -e "${BLUE}==================================================${NC}"
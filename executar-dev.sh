...
echo -e "${BLUE}==================================================${NC}"
echo -e "${BLUE}   EXECUTANDO AMBIENTE DE DESENVOLVIMENTO         ${NC}"
echo -e "${BLUE}==================================================${NC}"
...
# Executar backend em segundo plano
echo -e "${YELLOW}Iniciando backend em segundo plano...${NC}"
cd backend
...
# Executar frontend em segundo plano
echo -e "${YELLOW}Iniciando frontend em segundo plano...${NC}"
cd frontend
...
echo "$BACKEND_PID $FRONTEND_PID" > dev-pids.txt